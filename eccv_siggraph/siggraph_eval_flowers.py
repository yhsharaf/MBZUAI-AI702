...
def save_images(img, original, grayscale, colorized):
    ...
    folder_path = os.path.join(os.getcwd(), f"siggraph_test_flowers")
...
def evaluate_siggraph17(model, test_loader, device):
    ...
    with open("siggraph_flowers_eval.txt", "w") as f:
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("siggraph17_flowers_trained.pth"))
